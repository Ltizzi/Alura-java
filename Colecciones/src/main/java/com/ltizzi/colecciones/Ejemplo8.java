...
public class Ejemplo8 {
  ...
  public static final List<List<Integer>> listas =
  ...
  public static void main(String[] args) {
    ...
    for (List<Integer> lista : listas) {
      ...
      // LINKEDLIST A<-> B <-> C <-> D ->  A<-> B1 <-> B2 <-> C <-> D

      // ARRAYLIST A , B, C, D  -> A, B1, B, C, D

      // array list mueve toda la lista si se queire agregar algo, el linkedlist solo cambia una
      // relación, pero después es más performatico el arraylist
    }
  }
}
